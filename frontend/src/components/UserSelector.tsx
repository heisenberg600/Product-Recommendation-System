...
import { Search, Users, Crown, UserPlus, Check } from 'lucide-react';
    ...
    <div className="card p-5">
      ...
      <div className="flex gap-2 mb-4">
        ...
        >
          ...
          <span>Loyal</span>
          <span className={`text-xs px-1.5 py-0.5 rounded ${activeTab === 'loyal' ? 'bg-amber-400' : 'bg-slate-200'}`}>
        ...
        >
          ...
          <span>New</span>
          <span className={`text-xs px-1.5 py-0.5 rounded ${activeTab === 'new' ? 'bg-emerald-400' : 'bg-slate-200'}`}>
